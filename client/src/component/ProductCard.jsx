...
export default function ProductCard({ name, price, specs, imageURL }) {
  //dummy url for now
  // const imageURL =
  ...
  return (
    <div className="h-100 w-100">
      <h1 className="text-center text-[24px] position:absolute overflow-hidden line-clamp-2 hover:line-clamp-none">
        {name}
      </h1>
      <img
